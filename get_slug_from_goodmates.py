...
wrkbk = openpyxl.load_workbook("GOODMATES - Product Database.xlsx", data_only=True)
# Fashion Biz CA - Product Details WIP
# Fashion Biz AU NZ - Product Details
...
for i in range(2, 950):
    ...
    cell_product_slug = sh.cell(row=i, column=10).value
    ...
    if pro_slug in list1:
        continue
    else:
        list1.append(pro_slug)
